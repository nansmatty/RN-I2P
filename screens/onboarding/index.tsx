...
export default function OnboardingScreen() {
	...
	return (
		<SafeAreaView edges={['top']} style={{ flex: 1, backgroundColor: 'white' }}>
			{/* Background gradient */}
			<LinearGradient colors={['#ffffff', '#f8f9ff', '#f0f4ff']} style={{ flex: 1 }} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }}>
					...
					<View
						...
						<Animated.View
							style={{
								...
								top: '15%',
								left: '10%',
								transform: [{ rotate: pinkSpin }, { translateY: pinkFloatY }],
								opacity: 0.6,
							}}
						/>
						...
						<Animated.View
							style={{
								...
								bottom: '10%',
								right: '5%',
								transform: [{ rotate: blueSpin }, { translateY: blueFloatY }],
								opacity: 0.5,
							}}
						/>
						...
						<Animated.View
							style={{
								...
								top: '25%',
								right: '20%',
								transform: [{ rotate: yellowSpin }, { translateY: yellowFloatY }],
								opacity: 0.5,
							}}
						/>
						...
						<Animated.View
							style={{
								...
								bottom: '25%',
								left: '15%',
								transform: [{ rotate: greenSpin }, { translateY: greenFloatY }],
								opacity: 0.4,
							}}
						/>
